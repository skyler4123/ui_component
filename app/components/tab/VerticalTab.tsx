...
const VerticalTab: React.FC<VerticalTabType> = ({tabs, headerClass = initHeaderClass, headClass = initHeadClass, contentsClass = initContentsClass, contentClass = initContentClass}) => {
